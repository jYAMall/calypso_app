          ...
          routes: [
            ...
            FFRoute(
              ...
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'Collection')
                  : CollectionWidget(),
            ),
            FFRoute(
              name: 'QRCodeDetails',
              ...
              requireAuth: true,
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'QRCodeDetails')
                  : QRCodeDetailsWidget(
                      codeReference: params.getParam(
                        'codeReference',
                        ParamType.DocumentReference,
                        isList: false,
                        collectionNamePath: ['qr_codes'],
                      ),
                    ),
            ),
            FFRoute(
